...
plt.yscale('log')
plt.savefig('./graph/orthogonal_loss_%s' % epoch)
plt.close()
...
plt.yscale('log')
plt.savefig('./graph/orthogonal_condition_number_%s' % epoch)
plt.close()
...
plt.yscale('log')
plt.savefig('./graph/orthogonal_max_learning_rate_%s' % epoch)
plt.close()
...
plt.yscale('log')
plt.savefig('./graph/orthogonal_max_singular_%s' % epoch)
plt.close()
...
plt.yscale('log')
plt.savefig('./graph/orthogonal_min_singular_%s' % epoch)
plt.close()
...
# plt.legend(loc='upper left')
# plt.yscale('log')
# plt.savefig('./graph/orthogonal_condition_number')
# plt.close()
...
# plt.legend(loc='upper left')
# plt.yscale('log')
# plt.savefig('./graph/orthogonal_max_learningRate')
# plt.close()
